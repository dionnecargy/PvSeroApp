...
```{r standard curves plot, fig.width=6, fig.height=4.5, out.width='\\linewidth'}
params$stdcurve_plot
```
\newpage
#### Plot of Model Results

```{r model results plot, results='asis', fig.width=6, fig.height=4.5, out.width='\\linewidth'}
...
```{r bead counts plot, fig.width=6, fig.height=4.5, out.width='\\linewidth'}
plateqc_plot <- params$plateqc_plot
plateqc_plot + theme(legend.position = "bottom")
```

```{r check repeats table, echo=FALSE, results='asis', fig.width=6, fig.height=4.5, out.width='\\linewidth'}
...
```{r blank samples plot, fig.width=6, fig.height=4.5, out.width='\\linewidth'}
...
`r knitr::asis_output(params$plate_list_output)`